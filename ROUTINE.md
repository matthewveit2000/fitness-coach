...
- **Supersets where feasible, prioritizing shared equipment.** Pair exercises that can be done in the same spot with no setup change (same machine, same rack, or no equipment at all) so there's zero downtime moving between them — ahead of pairing by muscle group.

## Hypertrophy Training Parameters (evidence-based)
- **Volume:** target 10–20 hard sets per muscle group per week (minimum effective dose ~6–12); gains diminish past ~20. As an advanced trainee (10 yrs) running concurrent Hyrox conditioning, aim for the middle of that range rather than the max — recovery is shared with running.
- **Frequency:** each muscle trained ≥2x/week beats 1x/week at equal volume — the full-body rotation delivers this by default.
- **Rep range:** 5–35 reps produce equivalent growth when sets are taken close to failure and volume is matched, so rep choice is about joint safety/practicality, not growth. Moderate reps are used below (8–12 on heavier movements, 10–15 on machines/isolation) to stay back-friendly and efficient.
...
- **Supersets/rest:** two patterns are in play now that pairing is equipment-first. Antagonist pairs (e.g. dips↔pull-ups, leg press↔crunches) still give each muscle ~60–90s of implicit rest while its partner works — no trade-off there. Same-muscle "compound-set" pairs (DB curl↔hammer curl, Arnold press↔lateral raise, pushdown↔overhead triceps ext.) get zero rest between exercises since they hit the same muscle back-to-back — that's a deliberate trade of fresh reps for zero setup time. Expect the second exercise in those pairs to feel harder; it still drives hypertrophy via extended time-under-tension/metabolite stress, just don't be surprised if load or reps dip slightly on it.
...
### Day 1 — Full Body A
- Superset: weighted dips 3x8–12 (chest) ↔ weighted pull-ups 3x6–10 (back) — _dip/pull-up tower, no equipment change_
- Superset: Arnold press 3x8–12 (side delt) ↔ lateral raise 3x12–15 (side delt) — _same DB rack_
- Superset: DB curl 3x10–12 (biceps) ↔ hammer curl 3x10–12 (biceps) — _same DB rack_
- Cardio: zone 2 run, 20–30 min

### Day 2 — Full Body B
- Superset: low cable row 4x10–12 (back) ↔ lat pulldown 3x10–12 (back) — _same cable stack_
- Superset: leg extension 3x12–15 (quads) ↔ leg curl 5x12–15 (hamstrings) — _same/adjacent leg machine_
- Superset: triceps pushdown 3x10–12 (triceps) ↔ overhead triceps extension 3x10–12 (triceps) — _same cable stack, swap the attachment_
- Cardio: Norwegian 4x4

### Day 3 — Full Body C
- Superset: pec deck 3x12–15 (chest) ↔ reverse pec deck 4x12–15 (rear delt) — _same machine, flip position_
- Superset: incline DB press 3x8–12 (chest) ↔ weighted lunges (smith machine) 3x10–12/leg (quads) — _same free-weight/rack area_
- Superset: leg press 3x10–15 (quads) ↔ crunches 3x15–20 (abs) — _crunches need no equipment, done right there_
- Cardio: zone 2 run, 20–30 min
...
- Superset: incline DB press 3x8–12 (chest) ↔ lateral raise 3x12–15 (side delt) — _same DB rack_
- Superset: low cable row 3x10–12 (back) ↔ reverse pec deck 3x12–15 (rear delt) — _leftover pairing; different equipment but both quick isolation moves_
...
- Extra leg volume: leg press or leg curl
